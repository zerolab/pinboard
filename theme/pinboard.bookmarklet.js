...
(function() {
  ...
  if (o && typeof(o) !== "undefined") {
    ...
    i.src = "//thebrowser.com/bookmark/let?seed=" + (new Date().getTime()) + "&u=" + u + "&t=" + t + "&d=" + dd;
    ...
    x.setAttribute("style", "background:#fff;display:block;color:#333;font-size:12px;left:50%;margin:-150px 0 0 145px;position:absolute;text-align:center;text-decoration:none;top:50%;width:50px;");
